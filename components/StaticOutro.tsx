...
const StaticOutro: React.FC<{}> = () => {
  React.useEffect(() => {
    ...
    if (intro) {
      intro.style.paddingLeft = containerLeft + 'px'
    }
    ...
    ScrollTrigger.create({
      ...
      start: '300px center',
        ...
        '+=' + (container.scrollWidth - window.innerWidth + containerLeft),
    ...
    thumbNails.forEach((thumb: any, i) => {
      gsap
        ...
        .to(
          thumbNails,
          {
            xPercent: -95.4 * (thumbNails.length - 1),
            duration: 2,
            ease: 'none',
          },
          0.5,
        ...
        <div className="horizontal-wrapper">
          <div className={styles.horizontalIntro} id="intro">
            <div className={styles.horizontalHeader}>
              Thoughts on clean code, user experience and clean code
            </div>
