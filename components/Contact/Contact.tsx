        ...
        <Row>
          <Col>
            ...
            <p className={styles.emailButton}>
              <a href="mailto:gian@johansen.software">gian@johansen.software</a>
            </p>
            <p className={styles.socials}>
              <a href="https://au.linkedin.com/in/gianjohansen" target="_blank">
                {' '}
                <svg
              ...
              <a href="https://github.com/gianjohansen" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="36"
                  height="36"
              ...
              <a href="https://twitter.com/gianjohansen" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="36"
                  height="36"
