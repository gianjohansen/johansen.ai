            ...
            <Col xs={12} sm={6} className={styles.desktopRight}>
              ...
              >
                <div className={styles.pdfIcon}>
                  ...
                  >
                    <g fill="#ffffff">
                      <path d="M40.88 14H39v10h2.185c1.815 0 3.209-.213 4.184-1.129.976-.916 1.463-2.125 1.463-3.872 0-1.746-.487-2.868-1.463-3.809-.974-.941-2.472-1.19-4.489-1.19zM28.123 14.462c-.62-.432-1.582-.462-2.888-.462H23v6h2.642c1.323 0 2.222-.465 2.697-.999.475-.534.712-1.319.712-2.346 0-1.026-.31-1.76-.928-2.193z"></path>
                      <path d="M77 0H5a5 5 0 00-5 5v28a5 5 0 005 5h72a5 5 0 005-5V5a5 5 0 00-5-5zM31.201 21.493C29.92 22.511 27.965 23 25.337 23H23v5h-4V10h6.286c2.73 0 4.719.64 5.965 1.699s1.87 2.732 1.87 4.929-.64 3.848-1.92 4.865zm17.145 4.091C46.692 27.195 44.17 28 40.778 28H35V10h5.981c3.171 0 5.604.885 7.301 2.437s2.544 3.765 2.544 6.529-.826 5.007-2.48 6.618zM65 14h-8v4h8v3h-8v7h-4V10h12v4z"></path>
                    </g>
                  </svg>
                </div>
